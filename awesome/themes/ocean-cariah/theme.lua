...
theme = {}
theme.theme_dir = awful.util.getdir("config") .. "/themes/ocean-cariah"
theme.wallpaper_cmd = { "awsetbg /home/roelof/.config/awesome/themes/ocean-cariah/background.jpg" }

theme.font          = "lemon"

theme.bg_normal     = "#2B303B"
theme.bg_focus      = "#4F5B66"
theme.bg_urgent     = "#bf616a"
theme.bg_minimize   = "#343D46"

theme.fg_normal     = "#dfe1e8"
theme.fg_focus      = "#dfe1e8"
theme.fg_urgent     = "#8fa1b3"
theme.fg_minimize   = "#eff1f5"
